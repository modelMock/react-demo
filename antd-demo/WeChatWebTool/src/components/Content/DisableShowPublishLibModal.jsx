 ...
 * 内容库=>批量作废
 */
 class DisableShowPublishLibModal extends Component{
   constructor(props){
     super(props);
     this.state={
       visible:props.disableShowVisible,
     };
   ...
   handleOk(e){
     ...
     this.props.form.validateFields((errors, values) => {
       if(!!errors) return;
       Confirm(function(){
         ContentService.disableShowPublishLib({record_ids:this.props.recordKeys}).then(({jsonResult})=>{
           Success("提交成功!");
           this.handleCancel();
...
export default Form.create()(DisableShowPublishLibModal);
