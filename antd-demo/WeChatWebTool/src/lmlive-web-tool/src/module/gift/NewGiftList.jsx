...
export default class NewGiftList extends TablePanel {
  constructor(props) {
    super(props);
    this.state = {
      // 控制 添加、修改礼物框显示、隐藏
  ...
  handleSearch(e) {
    ...
    params
    this.doFormSearch(params)
  }
  doSearch = (params, successFn, failFn) => {
    ConfigService.selectGoodsConfig(params).then(result => {
      this.setState({
        money: 12000,
      })
  ...
  render() {
    ...
    return <div>
        ...
        {this.renderTable({pageSize:5, rowKey: 'goodsId', columns: this.__getColumns(), scroll: {x: 1560}, title: this.tableTitle})}
